<?php
if(!class_exists('DFM_Dropshippers_Settings'))
{
    class DFM_Dropshippers_Settings
    {
        /**
        ...
        {
            register_setting('DFM_WooCommerce_Dropshippers', 'dfm_woocommerce_dropshippers_options', 'dfm_woocommerce_dropshippers_validate_settings');
            // add a settings section
            add_settings_section(
                'DFM_WooCommerce_Dropshippers-section', 
                __('WooCommerce Dropshipper Settings','woocommerce-dropshippers'), 
                array(&$this, 'settings_section_woocommerce_dfm_dropshippers'), 
            ...
            add_settings_field(
                ...
                __('Show customer phone number to dropshippers (this will appear on PDF Packing Slip too)','woocommerce-dropshippers'),
            ...
            add_settings_field(
                ...
                __('Show customer email to dropshippers (this will appear on PDF Packing Slip too)','woocommerce-dropshippers'),
            ...
            add_settings_field(
                'woocommerce_dropshippers_can_see_customer_order_notes_on_pdf',
                __('Show Customer Order Notes on packing slip too','woocommerce-dropshippers'),
                array(&$this, 'settings_field_can_see_customer_order_notes_on_pdf'),
                'DFM_WooCommerce_Dropshippers',
                'DFM_WooCommerce_Dropshippers-section'
            );
            add_settings_field(
        ...
        public function settings_section_woocommerce_dfm_dropshippers()
        {
        ...
        public function settings_field_show_prices()
        {
            ...
            echo '<select id="woocommerce_dropshippers_show_prices" name="dfm_woocommerce_dropshippers_options[show_prices]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. ( isset($options['show_prices']) && ($options['show_prices']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_input_text()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<select id="woocommerce_dropshippers_text_string" name="dfm_woocommerce_dropshippers_options[text_string]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['text_string']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_billing_address()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<textarea style="width: 300px; height: 150px;" id="woocommerce_dropshippers_billing_address" name="dfm_woocommerce_dropshippers_options[billing_address]">' . (isset($options['billing_address'])?$options['billing_address']:'') .'</textarea>'."\n";
        } // END
        public function settings_field_mark_as_shipped()
        {
            ...
            echo '<select id="woocommerce_dropshippers_mark_as_shipped" name="dfm_woocommerce_dropshippers_options[mark_as_shipped]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['mark_as_shipped']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_send_tracking_info()
        {
            ...
            echo '<select id="woocommerce_dropshippers_send_tracking_info" name="dfm_woocommerce_dropshippers_options[send_tracking_info]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['send_tracking_info']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_can_see_email()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<select id="woocommerce_dropshippers_can_see_email" name="dfm_woocommerce_dropshippers_options[can_see_email]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['can_see_email']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_can_see_phone()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<select id="woocommerce_dropshippers_can_see_phone" name="dfm_woocommerce_dropshippers_options[can_see_phone]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['can_see_phone']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_send_pdf()
        {
            ...
            echo '<select id="woocommerce_dropshippers_send_pdf" name="dfm_woocommerce_dropshippers_options[send_pdf]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['send_pdf']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_company_logo()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<input type="text" id="woocommerce_dropshippers_company_logo" name="dfm_woocommerce_dropshippers_options[company_logo]" value="'.(isset($options['company_logo'])?$options['company_logo']:'').'" />'."\n";
        ...
        public function settings_field_slip_footer()
        {
            ...
            echo '<textarea style="width: 300px; height: 150px;" id="woocommerce_dropshippers_slip_footer" name="dfm_woocommerce_dropshippers_options[slip_footer]">' . (isset($options['slip_footer'])?$options['slip_footer']:'') .'</textarea>'."\n";
        } // END
        public function settings_field_slip_images()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            if(! isset($options['slip_images'])){ $options['slip_images'] = 'No'; }
            echo '<select id="woocommerce_dropshippers_slip_images" name="dfm_woocommerce_dropshippers_options[slip_images]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['slip_images']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_admin_email()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<input type="email" id="woocommerce_dropshippers_admin_email" name="dfm_woocommerce_dropshippers_options[admin_email]" value="'.(isset($options['admin_email'])?$options['admin_email']:'').'" />'."\n";
        } // END
        public function settings_field_from_email()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<input type="email" id="woocommerce_dropshippers_from_email" name="dfm_woocommerce_dropshippers_options[from_email]" value="'.(isset($options['from_email'])?$options['from_email']:'').'" />'."\n";
        } // END
        public function settings_field_admin_email_cc()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<input type="email" id="woocommerce_dropshippers_admin_email_cc" name="dfm_woocommerce_dropshippers_options[admin_email_cc]" value="'.(isset($options['admin_email_cc'])?$options['admin_email_cc']:'').'" />'."\n";
        } // END
        public function settings_field_dropshipper_email_bcc()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            echo '<input type="email" id="woocommerce_dropshippers_dropshipper_email_bcc" name="dfm_woocommerce_dropshippers_options[dropshipper_email_bcc]" value="'.(isset($options['dropshipper_email_bcc'])?$options['dropshipper_email_bcc']:'').'" />'."\n";
        } // END
        public function settings_field_can_see_email_shipping()
        {
            ...
            echo '<select id="woocommerce_dropshippers_can_see_email_shipping" name="dfm_woocommerce_dropshippers_options[can_see_email_shipping]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['can_see_email_shipping']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_can_put_order_to_completed()
        {
            ...
            echo '<select id="woocommerce_dropshippers_can_put_order_to_completed" name="dfm_woocommerce_dropshippers_options[can_put_order_to_completed]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['can_put_order_to_completed']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_can_add_droshipping_fee()
        {
                ...
                echo '<select id="woocommerce_dropshippers_can_add_droshipping_fee" name="dfm_woocommerce_dropshippers_options[can_add_droshipping_fee]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['can_add_droshipping_fee']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_can_see_customer_order_notes()
        {
            ...
            echo '<select id="woocommerce_dropshippers_can_see_customer_order_notes" name="dfm_woocommerce_dropshippers_options[can_see_customer_order_notes]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['can_see_customer_order_notes']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        public function settings_field_can_see_customer_order_notes_on_pdf()
        {
            $options = get_option('dfm_woocommerce_dropshippers_options');
            if(! isset($options['can_see_customer_order_notes_on_pdf'])){ $options['can_see_customer_order_notes_on_pdf'] = 'No'; }
            echo '<select id="woocommerce_dropshippers_can_see_customer_order_notes" name="dfm_woocommerce_dropshippers_options[can_see_customer_order_notes_on_pdf]"><option value="Yes">'. __('Yes','woocommerce-dropshippers') .'</option><option value="No" '. (($options['can_see_customer_order_notes_on_pdf']=='No')?'selected="selected"':'') . '>'. __('No','woocommerce-dropshippers') .'</option></select>'."\n";
        } // END
        /**
         * add a menu
         */     
        public function add_menu()
        {
            ...
            if(current_user_can('manage_options')){
                ...
                add_submenu_page(
                    ...
                    'manage_woocommerce',
                    'dfm_dropshippers_bulk_price',
                    array(&$this, 'bulk_price_page')
                );
            }
            else{
                remove_submenu_page( 'DFM_WooCommerce_Dropshippers', 'woocommerce-dfm-dropshippers' );
                add_submenu_page(
                    'DFM_WooCommerce_Dropshippers',
                    __('WooCommerce Dropshipper Bulk Assign','woocommerce-dropshippers'),
                    __('Bulk Assign','woocommerce-dropshippers'),
        ...
        public function plugin_settings_page(){
            ...
            ?>
            <style type="text/css">
                .settings-tabs nav.dfmnet-nav-tab-wrapper{
                    border-bottom: 1px solid #ccc;
                    margin: 1.5em 0 1em;
                }
                .settings-tabs nav.dfmnet-nav-tab-wrapper a{
                    box-shadow: none;
            ...
            <div class="wrap">
                ...
                <div class="settings-tabs">
                    <nav class="nav-tab-wrapper dfmnet-nav-tab-wrapper">
                        ...
                        <a class="nav-tab " href="#" onclick="return false;" open-tab="dropshipper-setting-tab-email"><?php echo __('Email','woocommerce-dropshippers'); ?></a>
                ...
                <form method="post" action="options.php" class="woocommerce-dropshippers-settings-form">
                    <?php
                        settings_fields( 'DFM_WooCommerce_Dropshippers' );
                        do_settings_sections( 'DFM_WooCommerce_Dropshippers' );
                    ?>
            ...
            <script type="text/javascript">
                ...
                jQuery('.woocommerce-dropshippers-settings-form .form-table tr').each(function(j,k){
                    if(j>=0 && j<=3){
                        ...
                        jQuery(k).addClass('dropshipper-setting').addClass('dropshipper-setting-tab-email');
                    }
                    else if(j>=8 && j<=14){
    ...
    } // END class woocommerce-dfm-dropshippers_Settings
    new DFM_Dropshippers_Settings();
} // END if(!class_exists('woocommerce-dfm-dropshippers_Settings'))
?>